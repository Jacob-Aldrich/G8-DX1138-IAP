...
You can recruit up to **10 survivors**.
...
When all turns are used, the game moves into the night phase.
...
You can recruit survivors during the pre-nightfall phase.

You can have a maximum of **10 survivors**.
...
When all available turns are used, the game enters the night phase.

Night scenarios may include:

* Visitors knocking on the door
* Survivors asking for help
* Skinwalkers attempting to trick the player
* Hostile enemies attacking the house
* Door damage
* Events involving safety, resources and other people

After the night phase, the day counter increases and the next day begins.
